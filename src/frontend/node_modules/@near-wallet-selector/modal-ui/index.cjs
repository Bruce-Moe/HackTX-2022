...
var uncurryThis$g = NATIVE_BIND$3 && bind$5.bind(call$f, call$f);
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$g(fn = input.toString) && !isObject$4(val = call$d(fn, input))) return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$4(val = call$d(fn, input))) return val;
  if (pref !== 'string' && isCallable$g(fn = input.toString) && !isObject$4(val = call$d(fn, input))) return val;
      ...
      children: jsxRuntime.jsxs("div", Object.assign({
        ...
        children: [jsxRuntime.jsx("div", Object.assign({
          ...
          children: [jsxRuntime.jsx("div", Object.assign({
            ...
            children: ["Connecting to ", wallet === null || wallet === void 0 ? void 0 : wallet.metadata.name, "..."]
          })]
        }))]
      }))
    }))]
...
const DerivationPath = ({
  ...
  const [headerTitle, setHeaderTitle] = React.useState("Connect with Ledger");
  ...
  return jsxRuntime.jsxs("section", Object.assign({
    ...
    children: [jsxRuntime.jsx(ModalHeader, {
      ...
      children: [jsxRuntime.jsx("div", {
        ...
        children: [jsxRuntime.jsx(CopyIcon, {}), "Copy to clipboard"]
      }))]
    })), jsxRuntime.jsxs("footer", Object.assign({
      className: "footer"
    }, {
      children: [jsxRuntime.jsx("p", {
        children: "Prefer the official WalletConnect dialogue?"
      }), jsxRuntime.jsx("button", Object.assign({
        className: "btn",
