...
export declare type WalletConnectedParams = {
    module: ModuleState | undefined;
};
export declare type ScanQRCodeParams = {
    wallet: Wallet;
...
export declare type WalletHome = {
    name: "WalletHome";
};
export declare type WalletConnected = {
    name: "WalletConnected";
    params?: WalletConnectedParams;
};
export declare type ScanQRCode = {
    name: "ScanQRCode";
